...
//
// Listener
// void MyEventHandler(float speed)
// ...
//
// Usage example:
...
//new Dictionary<Test, int>(new MyEnumComparer());

static internal class MessengerInternal
{
	readonly public static Dictionary<Messages, Delegate> eventTable = new Dictionary<Messages, Delegate>(new MessagesCOmparer());
	...
	static public void OnBroadcasting (Messages eventType, MessengerMode mode)
	{
...
static public class Messenger
{
	...
	static public void AddListener<TReturn>(Messages eventType, Func<TReturn> handler)
	{
		MessengerInternal.AddListener(eventType, handler);
	}
	...
	static public void RemoveListener<TReturn>(Messages eventType, Func<TReturn> handler)
	{
		MessengerInternal.RemoveListener(eventType, handler);
	}
	...
	static public void Broadcast<TReturn>(Messages eventType, Action<TReturn> returnCall)
	{
		Broadcast(eventType, returnCall, MessengerInternal.DEFAULT_MODE);
	}

	static public void Broadcast (Messages eventType, MessengerMode mode)
	{
	...
	static public void Broadcast<TReturn>(Messages eventType, Action<TReturn> returnCall, MessengerMode mode)
	{
		MessengerInternal.OnBroadcasting(eventType, mode);
...
static public class Messenger<T>
{
	...
	static public void AddListener<TReturn>(Messages eventType, Func<T, TReturn> handler)
	{
		MessengerInternal.AddListener(eventType, handler);
	}
	...
	static public void Broadcast<TReturn>(Messages eventType, T arg1, Action<TReturn> returnCall)
	{
		Broadcast(eventType, arg1, returnCall, MessengerInternal.DEFAULT_MODE);
	}

	static public void Broadcast (Messages eventType, T arg1, MessengerMode mode)
	{
		MessengerInternal.OnBroadcasting(eventType, mode);
	...
	static public void Broadcast<TReturn>(Messages eventType, T arg1, Action<TReturn> returnCall, MessengerMode mode)
	{
		MessengerInternal.OnBroadcasting(eventType, mode);
...
{
	static public void AddListener (Messages eventType, Action<T, U> handler)
	{
		MessengerInternal.AddListener(eventType, handler);
	}

	static public void AddListener<TReturn>(Messages eventType, Func<T, U, TReturn> handler)
	{
		MessengerInternal.AddListener(eventType, handler);
	}

	static public void RemoveListener (Messages eventType, Action<T, U> handler)
	{
		MessengerInternal.RemoveListener(eventType, handler);
	}

	static public void RemoveListener<TReturn>(Messages eventType, Func<T, U, TReturn> handler)
	{
		MessengerInternal.RemoveListener(eventType, handler);
	}

	static public void Broadcast (Messages eventType, T arg1, U arg2)
	{
		Broadcast(eventType, arg1, arg2, MessengerInternal.DEFAULT_MODE);
	}

	static public void Broadcast<TReturn>(Messages eventType, T arg1, U arg2, Action<TReturn> returnCall)
	{
		Broadcast(eventType, arg1, arg2, returnCall, MessengerInternal.DEFAULT_MODE);
	}

	static public void Broadcast (Messages eventType, T arg1, U arg2, MessengerMode mode)
	{
		MessengerInternal.OnBroadcasting(eventType, mode);
	...
	static public void Broadcast<TReturn>(Messages eventType, T arg1, U arg2, Action<TReturn> returnCall, MessengerMode mode)
	{
		MessengerInternal.OnBroadcasting(eventType, mode);
...
{
	static public void AddListener (Messages eventType, Action<T, U, V> handler)
	{
		MessengerInternal.AddListener(eventType, handler);
	}

	static public void AddListener<TReturn>(Messages eventType, Func<T, U, V, TReturn> handler)
	{
		MessengerInternal.AddListener(eventType, handler);
	}

	static public void RemoveListener (Messages eventType, Action<T, U, V> handler)
	{
		MessengerInternal.RemoveListener(eventType, handler);
	}

	static public void RemoveListener<TReturn>(Messages eventType, Func<T, U, V, TReturn> handler)
	{
		MessengerInternal.RemoveListener(eventType, handler);
	}

	static public void Broadcast (Messages eventType, T arg1, U arg2, V arg3)
	{
		Broadcast(eventType, arg1, arg2, arg3, MessengerInternal.DEFAULT_MODE);
	}

	static public void Broadcast<TReturn>(Messages eventType, T arg1, U arg2, V arg3, Action<TReturn> returnCall)
	{
		Broadcast(eventType, arg1, arg2, arg3, returnCall, MessengerInternal.DEFAULT_MODE);
	}

	static public void Broadcast (Messages eventType, T arg1, U arg2, V arg3, MessengerMode mode)
	{
		MessengerInternal.OnBroadcasting(eventType, mode);
	...
	static public void Broadcast<TReturn>(Messages eventType, T arg1, U arg2, V arg3, Action<TReturn> returnCall, MessengerMode mode)
	{
		MessengerInternal.OnBroadcasting(eventType, mode);
